...
const LandingPage: React.FC<LandingPageProps> = ({ onEnterApp }) => {
  ...
  return (
    <div className="min-h-screen bg-bg-default text-text-default font-sans antialiased">
      {/* Hero Section */}
      <section className="relative py-16 md:py-24 overflow-hidden bg-gradient-to-br from-bg-default to-gray-900">
        ...
        <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="md:w-1/2 text-center md:text-left animate-fade-in-up">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-text-heading">GanhosPro</h1>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold leading-tight mb-4 text-text-heading">
              Seu Lucro Real por KM e Hora
            </h2>
            <p className="text-lg md:text-xl text-text-muted mb-8 max-w-md mx-auto md:mx-0">
          ...
          <div className="md:w-1/2 flex justify-center items-center mt-12 md:mt-0 animate-fade-in-up delay-200">
            <div className="relative w-64 h-auto aspect-[9/18] bg-bg-card rounded-[2.5rem] border-[10px] border-border-card shadow-2xl p-2 transform rotate-y-[-15deg] rotate-x-[10deg] transition-transform duration-500 hover:rotate-y-0 hover:rotate-x-0">
              <div className="w-full h-full bg-bg-default rounded-[2rem] p-4 flex flex-col">
                <div className="text-center text-brand-primary font-semibold text-xl mb-4">GanhosPro</div>
                <div className="bg-bg-card/50 rounded-xl p-3 text-center mb-3">
                  <p className="text-sm text-text-muted">Lucro Líquido</p>
                  <span className="text-3xl font-bold text-green-400">R$ 125,30</span>
                </div>
                <div className="grid grid-cols-2 gap-2 flex-grow">
                  <div className="bg-bg-card/50 rounded-xl p-2 text-center">
                    <p className="text-xs text-text-muted">Lucro/KM</p>
                    <span className="text-lg font-bold text-green-400">R$ 0,70</span>
                  </div>
                  <div className="bg-bg-card/50 rounded-xl p-2 text-center">
                    <p className="text-xs text-text-muted">KM Rodados</p>
                    <span className="text-lg font-bold text-blue-400">180 km</span>
                  </div>
                  <div className="bg-bg-card/50 rounded-xl p-2 text-center">
                    <p className="text-xs text-text-muted">Ganhos Brutos</p>
      ...
      {/* Features Section */}
      <section id="features" className="py-16 md:py-24 bg-bg-default">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-bg-card p-6 rounded-lg shadow-lg border border-border-card hover:border-brand-primary transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-xl font-semibold mb-3 text-text-heading">Calculadora Diária Inteligente</h3>
              <p className="text-text-muted">Calcule seu lucro líquido por KM e por hora em segundos, considerando todos os seus custos.</p>
            </div>
            <div className="bg-bg-card p-6 rounded-lg shadow-lg border border-border-card hover:border-brand-primary transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-center w-14 h-14 rounded-full bg-brand-primary/10 text-brand-primary mx-auto mb-6">
                <BarChart2 size={28} />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-text-heading">Histórico Detalhado</h3>
              <p className="text-text-muted">Acompanhe todas as suas corridas, visualize tendências e exporte seus dados para análise.</p>
            </div>
            <div className="bg-bg-card p-6 rounded-lg shadow-lg border border-border-card hover:border-brand-accent transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-center w-14 h-14 rounded-full bg-brand-accent/10 text-brand-accent mx-auto mb-6">
                <Crown size={28} />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-text-heading">Recursos Premium (IA)</h3>
              <p className="text-text-muted">Desbloqueie análises avançadas com IA, relatórios inteligentes e muito mais para maximizar seus ganhos.</p>
            </div>
            <div className="bg-bg-card p-6 rounded-lg shadow-lg border border-border-card hover:border-brand-accent transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-center w-14 h-14 rounded-full bg-brand-accent/10 text-brand-accent mx-auto mb-6">
                <BrainCircuit size={28} />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-text-heading">Insights Personalizados</h3>
              <p className="text-text-muted">Receba dicas e análises da nossa IA para otimizar suas rotas e horários de trabalho.</p>
            </div>
            <div className="bg-bg-card p-6 rounded-lg shadow-lg border border-border-card hover:border-brand-accent transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-center w-14 h-14 rounded-full bg-brand-accent/10 text-brand-accent mx-auto mb-6">
                <FileBarChart2 size={28} />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-text-heading">Relatórios e Gráficos</h3>
              <p className="text-text-muted">Visualize seu desempenho com gráficos claros e relatórios detalhados por período.</p>
            </div>
            <div className="bg-bg-card p-6 rounded-lg shadow-lg border border-border-card hover:border-brand-accent transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-center w-14 h-14 rounded-full bg-brand-accent/10 text-brand-accent mx-auto mb-6">
                <CalendarDays size={28} />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-text-heading">Análise Periódica</h3>
              <p className="text-text-muted">Compare seus ganhos, custos e lucros em gráficos semanais, mensais ou anuais.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Install Section */}
      <section className="py-16 md:py-24 bg-bg-default">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            <div className="bg-bg-card p-8 rounded-lg shadow-lg border border-border-card w-full md:max-w-sm">
              <div className="flex items-center justify-center w-16 h-16 rounded-full bg-lime-400/10 text-lime-400 mx-auto mb-6">
                <Smartphone size={32} />
              </div>
              <h3 className="text-2xl font-semibold mb-4 text-text-heading">Android</h3>
              <ol className="list-decimal list-inside text-left text-text-muted space-y-2">
            ...
            <div className="bg-bg-card p-8 rounded-lg shadow-lg border border-border-card w-full md:max-w-sm">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-text-heading">iOS</h3>
              <ol className="list-decimal list-inside text-left text-text-muted space-y-2">
      ...
      {/* Footer */}
      <footer className="bg-bg-default py-8 text-center text-text-muted text-sm">
        <div className="container mx-auto px-4">
